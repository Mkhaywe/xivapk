            ...
            <b-tabs content-class="pt-0" justified class="nav-bordered">
                ...
                <b-tab active>
                    ...
                    <div class="p-3">
                        ...
                        <a href="https://wrapbootstrap.com/theme/Xiva Solutions -admin-dashboard-landing-template-WB0858DB6?ref=themesbrand" class="btn btn-danger btn-block mt-2" target="_blank"><i class="mdi mdi-basket mr-1"></i> Purchase Now</a>
                    </div>
                </b-tab>
            </b-tabs>
            <!-- Nav tabs -->
