...
<div class="left-side-menu">
    ...
    <div class="logo-box">
        <nuxt-link to="/">
            <span class="logo-sm">
                <img src="~/assets/images/logo-sm.png" alt height="70" width="240" />
                <!-- <span class="logo-lg-text-light">Xiva Solutions </span> -->
            </span>
    ...
    <simplebar class="h-100" data-simplebar>
        ...
        <div class="user-box text-center">
            ...
            <div class="dropdown">
                <a href="javascript: void(0);" class="text-reset dropdown-toggle h5 mt-2 mb-1 d-block" data-toggle="dropdown">Khara Kleb</a>
