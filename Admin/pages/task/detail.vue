        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="mb-1">Xiva Solutions  admin Dashboard Re-design</h4>
                                ...
                                <div class="card mb-2">
                                    <div class="p-2">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col pl-0">
                                                <a href="javascript:void(0);" class="text-muted font-weight-semibold">Xiva Solutions -sketch-design.zip</a>
