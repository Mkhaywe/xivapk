                    ...
                    <div class="row">
                            ...
                            <ul class="sitemap">
                                <li>
                                    <a href="javascript: void(0);" class="text-uppercase font-weight-bold">
                                        <img src="~/assets/images/logo-sm.png" alt height="12" class="mr-1" /> Xiva Solutions  Pages
                                    </a>
                                    <ul>
                                        <li>
                        ...
                        <div class="col-lg-4">
                            <ul class="sitemap">
                                <li>
                                    <a href="javascript: void(0);" class="text-uppercase font-weight-bold">
                                        <img src="~/assets/images/logo-sm.png" alt height="12" class="mr-1" /> Xiva Solutions 
                                    </a>
                                    <ul>
                                        <li>
                                            <a href="javascript: void(0);">
